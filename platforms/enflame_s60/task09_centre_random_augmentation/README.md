...
| --- | ---: | ---: | ---: |
| 通过 | 2.924597 ms | 1.422888 ms | 2.055x |
...
```bash
cd /data/kernelswift/platforms/enflame_s60/task09_centre_random_augmentation
TOPS_VISIBLE_DEVICES=0 python3 benchmark.py --warmup 200 --repeat 500 --num-warps 1
```
