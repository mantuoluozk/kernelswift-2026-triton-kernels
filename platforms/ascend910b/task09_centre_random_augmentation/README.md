...
| --- | ---: | ---: | ---: |
| 通过 | 2.301964 ms | 0.679200 ms | 3.389x |
...
```bash
cd /data/kernelswift-2026-triton-kernels/platforms/ascend910b/task09_centre_random_augmentation
source ../setup_env.sh
python benchmark.py --warmup 200 --repeat 500 --num-warps 1
```
