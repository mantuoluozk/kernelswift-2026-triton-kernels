...
| --- | ---: | ---: | ---: |
| 通过 | 2.569192 ms | 0.223235 ms | 11.509x |

关键配置：hidden block size 2048，4 个 Triton warps。本地最大绝对误差为 `3.125e-2`，误差来自 BF16 舍入和累加顺序变化，满足官方容差。

## 复现

```bash
cd /data/zk/kernelswift-2026-triton-kernels/platforms/bw1000/task07_mhc_post
