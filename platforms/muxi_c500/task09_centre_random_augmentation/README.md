...
```bash
cd /data/zk/kernelswift-2026-triton-kernels/platforms/muxi_c500/task09_centre_random_augmentation
CUDA_VISIBLE_DEVICES=0 python3 benchmark.py --warmup 200 --repeat 500 --num-warps 1
```
